		...
		<>
			...
			>
				...
				<motion.button
					...
					whileTap={{ scale: 0.95 }}
					className="bg-amber-500 text-gray-900 px-5 py-2 rounded-full font-medium hover:bg-amber-400 transition-colors duration-300"
				>
					Get in Touch
				</motion.button>
			</motion.div>
			...
			>
				...
				>
					<div className="w-8 h-8 flex flex-col justify-center items-center">
						<span className={`bg-white block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm ${mobileMenuOpen ? 'rotate-45 translate-y-1' : '-translate-y-1'}`}></span>
			...
			>
				<div className="container mx-auto px-4 py-8">
					...
					<motion.button
						...
						whileTap={{ scale: 0.95 }}
						className="bg-amber-500 text-gray-900 px-6 py-3 rounded-full font-medium hover:bg-amber-400 transition-colors duration-300 mt-10 w-full"
					>
						Get in Touch
					</motion.button>
				</div>
